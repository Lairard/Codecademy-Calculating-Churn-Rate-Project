...
for i in daily_transactions_split:
  transaction_clean = []
  for j in i:
    transaction_clean.append(j.strip())
...
zipper = zip(customers, sales, thread_sold)
def zippering():
  zippers = [a + ', ' + b + ', ' + c for a, b, c in zipper]
  return zippers
